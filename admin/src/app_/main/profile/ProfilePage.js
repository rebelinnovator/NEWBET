            ...
            <MuiThemeProvider theme={{
                        ...
                        <div className="p-16 sm:p-24">
                            <div className={classes.profileBg}>
                                ...
                                <div className="container" style={{padding: '10px'}}>
                                    <div className="student-name" style={{ background: 'rgba(0,0,0,.2)',borderRadius: '10px',padding: '40px 15px 20px', textAlign: 'center', position: 'relative', marginBottom: '20px'}}>
                                        ...
                                        <p style={{color: '#e2e9ef'}}>{user.email}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <TextFieldFormsy
                                    ...
                                    InputProps={{
                                        startAdornment: <InputAdornment position="start"><Icon className="text-20">mail</Icon></InputAdornment>,                    
                                    }}
                                    variant="outlined"
                                    value={user.balance}
                                    required
                ...
                <MuiThemeProvider theme={{
                    ...
                    >
                        ...
                        <DialogActions>
                            <Button onClick={() => this.props.history.push({pathname: '/forgot-password'})} color="primary">
                                Forgot Password?
                            </Button>
