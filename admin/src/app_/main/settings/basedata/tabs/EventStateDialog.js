...
export default class EventStateDialog extends React.Component {
  state = {
    open: false,
    type: '',
    row: {
      ...
      <div>
        {this.state.type === 'edit' &&
          <div>
            ...
            <IconButton onClick={(ev) => {
                ev.stopPropagation();
                if (window.confirm('Are you sure to remove this event state?')) {
        ...
        {this.state.type === 'add' &&
            <div className="flex items-center justify-end">
                <Button className="normal-case" variant="contained" color="primary" aria-label="Add Event State" onClick={(ev) => {
                    ev.stopPropagation();
                    this.handleClickOpen();
                }}>Add Event State</Button>
            </div>
        }
        <Dialog
        ...
        >
          <DialogTitle id="form-dialog-title">Event State</DialogTitle>
          <DialogContent>
            <DialogContentText>
              To edit to this event state, please enter name here.
            </DialogContentText>
            <TextField
              autoFocus
              margin="dense"
