...
const ToolbarLayout1 = ({classes, settings, toolbarTheme, location}) => {
    ...
    let key = {
        ...
        '/game'             :   'BETTING',
        '/manage/game'      :   'ManageBetting',
        '/manage/user'      :   'ManageUser',
        '/admin'            :   'AdminPanel',
        '/my'               :   'MyPanel',
        '/my/task'          :   'Task Center',
        '/my/owntask'       :   'My Task',
        '/my/invite'        :   'Invite friend',
        '/my/promotion'     :   'Promotion',
        '/my/promotion/bonusrecord'     :   'BonusRecord',
        '/my/promotion/applybonus'     :   'Apply Record',
        '/my/promotion/submitbonus'     :   'Apply To Balance ',

        '/my/bank'     :   'My Bank Card ',
        '/my/wallet'     :   'My Wallet ',
        '/my/financial'     :   'Financial ',
        '/my/complaint'     :   'Complaint && suggestion ',
