...
class Game extends Component {
    ...
    //      socket = io('https://rosenfeldpublishing.com')
        ...
        socket.on("startNewBetting",(data)=>{
            ...
            //balance
            this.props.setUserBalance(data.balance)
        })
    ...
    postCardInfo = () => {
        ...
        api.post('/game/bet', {
            ...
            if(res.data.success == true){
                ...
                this.props.setUserBalance(res.data.remain)
            ...
            }else
            {
                ...
                */
               this.props.showMessage({message:"Your balance is not enough. You should charge first!"})
            }
                ...
                content={
                    ...
                    <div className="p-8">
                        ...
                        <div style={{
                            ...
                            <h2>Record</h2>
                        <Link to={`/result/${this.state.selectedTab}`}>more</Link>
                        
                        </div>
                        {selectedTab === 0 && (
                            <GameResultTable type={0} limit={10} list={this.state.resultHistory0}/>
                        )}
                        {selectedTab === 1 && (
                            <GameResultTable type={1} limit={10} list={this.state.resultHistory1}/>

                        )}
                        {selectedTab === 2 && (
                            <GameResultTable type={2} limit={10} list={this.state.resultHistory2}/>
                        )}
                        {selectedTab === 3 && (
                            <GameResultTable type={3} limit={10} list={this.state.resultHistory3}/>
                        )}
                    </div>
                    ...
                    <div style={{
                        ...
                        <h2>Waiting Bets</h2>
                        <Link to={`/gameorder/${this.state.selectedTab}`}>more</Link>
                    </div>
                        {selectedTab === 0 && (
...
function mapDispatchToProps(dispatch)
{
    ...
    //   getUserInfo:Actions.getUserInfo,
        setUserBalance  :userActions.setUserBalance,
...
export default (withStyles(styles, {withThemem: true})(withReducer('gameApp',reducer)(connect(mapStateToProps, mapDispatchToProps)(Game))));